...
public class TopicTest {
	...
	public void testSpilit() {
		...
		splitted = StringDeal.split(topic, "/");
		topic = "/";
    ...
    public void testValidationProcess() {
        ...
        assertThat(new Topic("+")).isValid();
        
        assertThat(new Topic("+/tennis/#")).isValid();
        
        assertThat(new Topic("sport/+/player1")).isValid();
        
        assertThat(new Topic("")).isValid();
        
        assertThat(new Topic("root")).isValid();
    }
