...
public class ErrorCode {
	...
	public final static String ECODE_NO_AUTHORIZATION = "301";// 访问未授权
	...
	public static String getEmsg(String ecode, String... arguments) {
		...
		if (arguments.length > 0) {
			return StringDeal.format(emsg, arguments);
		} else {
			return emsg;
		}
	}
	...
	public static <T> T setErrorInfo(BaseRespMessage baseRespMessage,
			String ecode, String... arguments) {
		baseRespMessage.setEcode(ecode);
		baseRespMessage.setEmsg(getEmsg(ecode, arguments));
		return (T) baseRespMessage;
	}
}
